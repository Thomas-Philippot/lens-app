            ...
            <div className="border-gray-500 py-2 px-2 hover:bg-sky-800 w-full break-words cursor-pointer">
              <div className="flex justify-between relative">
                <div className="w-14 h-full flex pt-1 pl-1">
                  {
                    this.props.pub.mainPost.profile.picture && this.props.pub.mainPost.profile.picture.original ? (
                        <img src={this.props.pub.mainPost.profile.picture.original.url} className="w-12 h-12 rounded-full object-cover z-10 mb-1"/>
                    ) : this.props.pub.mainPost.profile.picture && this.props.pub.mainPost.profile.picture.uri ?(
                        <img src={this.props.pub.mainPost.profile.picture.uri} className="w-12 h-12 rounded-full object-cover z-10 mb-1"/>
                    ) : (
